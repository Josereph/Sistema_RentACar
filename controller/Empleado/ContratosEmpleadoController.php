<?php
// controller/Empleado/ContratosEmpleadoController.php
...
class ContratosEmpleadoController extends BaseEmpleadoController
{
    public function index()
    {
        ...
        $seccion = 'contratos';
        require PROJECT_ROOT_FS . '/views/empleado/contratos/index.php';
    }
    ...
    public function verPdf()
    {
        ...
        if ($contrato && !empty($contrato['pdf_path'])) {
            $rutaAbsoluta = PROJECT_ROOT_FS . '/' . $contrato['pdf_path'];
    ...
    public function generarPdf()
    {
        ...
        header('Location: ' . url('index.php?area=empleado&controller=ContratosEmpleado&action=index&success=pdf_generado'));
        exit;
    }
