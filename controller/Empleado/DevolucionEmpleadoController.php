<?php
// controller/Empleado/DevolucionEmpleadoController.php
...
class DevolucionEmpleadoController extends BaseEmpleadoController
{
    public function index()
    {
        parent::__construct();
        require PROJECT_ROOT_FS . '/views/empleado/devoluciones/index.php';
    }
    ...
    public function listado()
    {
        ...
        require PROJECT_ROOT_FS . '/views/empleado/devoluciones/listado.php';
    }
    ...
    public function registrar()
    {
        ...
        try {
            ...
            header('Location: ' . url('index.php?area=empleado&controller=ChecklistEmpleado&action=index&id_devolucion=' . $id_devolucion));
            exit;
        } catch (Exception $e) {
            header('Location: ' . url('index.php?area=empleado&controller=DevolucionEmpleado&action=index&error=1&msg=' . urlencode($e->getMessage())));
            exit;
        }
    }
}