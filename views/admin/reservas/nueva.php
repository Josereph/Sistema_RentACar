...
<div class="container-fluid mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/Sistema_RentACar/index.php?controller=Reservas&action=crear" method="POST">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="deposito" class="form-control" value="0">
                    </div>
                    <div class="col-md-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function verificarDisponibilidad() {
        ...
        fetch('/Sistema_RentACar/index.php?controller=Reservas&action=verificarDisponibilidad&id_vehiculo=' + vehiculo.value + '&fecha_inicio=' + fechaInicio.value + '&fecha_fin=' + fechaFin.value)
            .then(r => r.json())
            .then(d => {
                if (d.disponible) {
